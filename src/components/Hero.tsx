      ...
      <div className="container mx-auto px-6 relative z-10">
        <div className="max-w-4xl mx-auto text-center">
          ...
          >
            ...
            <span className="text-sm text-muted-foreground">Pioneering the Future of Technology</span>
          </motion.div>
          ...
          >
            Starklabs is a cutting-edge technology research facility pushing the boundaries 
            of artificial intelligence, quantum computing, and sustainable energy solutions.
          </motion.p>
          ...
          >
            {[
              ...
              { value: "120+", label: "Scientists" },
              { value: "15", label: "Patents Filed" },
              { value: "$2B+", label: "Research Funding" },
            ].map((stat, index) => (
